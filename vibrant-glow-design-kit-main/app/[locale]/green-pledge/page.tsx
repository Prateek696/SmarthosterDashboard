/**
 * Server Component - Green Pledge Page Entry Point (Locale-based)
 */
import { strapiApi } from "@/services/strapi.api";
import { mapToStrapiLocale } from "@/utils/strapi-helpers";
import GreenPledgePageClient from "../../green-pledge/page-client";
...
export default async function GreenPledgePage({ params }: PageProps) {
  ...
  let strapiData = null;
  try {
    strapiData = await strapiApi.getGreenPledgePage(strapiLocale, {
      cache: 'no-store'
    });
    ...
    console.log(`📊 Server: Green Pledge Strapi Data (locale: ${locale}):`);
  ...
  return <GreenPledgePageClient strapiData={strapiData} />;
}
