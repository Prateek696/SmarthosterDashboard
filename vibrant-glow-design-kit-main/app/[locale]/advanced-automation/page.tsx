/**
 * Server Component - Advanced Automation Page Entry Point (Locale-based)
 */
import { strapiApi } from "@/services/strapi.api";
import { mapToStrapiLocale } from "@/utils/strapi-helpers";
import AdvancedAutomationPageClient from "../../advanced-automation/page-client";
...
export default async function AdvancedAutomationPage({ params }: PageProps) {
  ...
  let strapiData = null;
  try {
    strapiData = await strapiApi.getAdvancedAutomationPage(strapiLocale, {
      cache: 'no-store'
    });
    ...
    console.log(`📊 Server: Advanced Automation Strapi Data (locale: ${locale}):`);
  ...
  return <AdvancedAutomationPageClient strapiData={strapiData} />;
}
