/**
 * Server Component - Legal Compliance Page Entry Point (Locale-based)
 */
import { strapiApi } from "@/services/strapi.api";
import { mapToStrapiLocale } from "@/utils/strapi-helpers";
import LegalCompliancePageClient from "../../legal-compliance/page-client";
...
export default async function LegalCompliancePage({ params }: PageProps) {
  ...
  let strapiData = null;
  try {
    strapiData = await strapiApi.getLegalCompliancePage(strapiLocale, {
      cache: 'no-store'
    });
    ...
    console.log(`📊 Server: Legal Compliance Strapi Data (locale: ${locale}):`);
  ...
  return <LegalCompliancePageClient strapiData={strapiData} />;
}
